...
END_TS
 ...
 INNER JOIN unica_temp.DE_FM_SS_20191114_MAM mam on stg.user_id=mam.user_id
...
-- CHANGE MANHATTAN ID'S
 AND        F.LYLTY_CMPGN_ID IN (6342752701, 6342752801,6342752901) 
...
WHERE 7=7 and end_ts>current_date
-- CHANGE MANHATTAN ID'S
 AND        F.LYLTY_CMPGN_ID IN (6342752901) 
          --AND        F.LYLTY_CMPGN_ID IN (6342746701 )  --6342733801
AND mam.segment = 'SEED15_T'
